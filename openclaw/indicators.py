"""Unified indicator interface — single-file entry point for all indicator backends.

Combines the routing layer and the ICT engine into one module:
  ...
  - Manual calculations (midnight open, kill zone, fibonacci OTE, contract sizing)
...
# ═══════════════════════════════════════════════════════════════════════════════
# ICT INDICATORS — Smart Money Concepts
# ═══════════════════════════════════════════════════════════════════════════════
