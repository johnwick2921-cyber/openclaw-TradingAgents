...
> **OpenClaw Tools:** You have access to web search and other OpenClaw tools during this analysis. Use web search to find the latest earnings estimates, analyst ratings, and SEC filings. Cross-reference pre-fetched fundamentals with latest analyst consensus. Use these to supplement the pre-fetched data below — don't rely on stale data alone.
