...
> **OpenClaw Tools:** You have access to web search and other OpenClaw tools during this analysis. Use web search to find social media sentiment, Reddit discussions, Twitter/X posts, and retail trader sentiment about {ticker}. Search multiple platforms for sentiment dispute. Use these to supplement the pre-fetched data below — don't rely on stale data alone.
